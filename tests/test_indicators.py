...
def test_macd_calc():
	...
	expected_results = pd.read_csv('price_history_macd_test.csv')
...
class TestIndicator(unittest.TestCase):
	...
	def test_macd_signal_SELL(self):
		...
		"""
		price_history = pd.read_csv('price_history_testSELL.csv')
		expected_result = -1
		latest_signal = indicators.macd_signal(price_history)
		self.assertEqual(latest_signal, expected_result)
	...
	def test_macd_signal_BUY(self):
		...
		"""
		price_history = pd.read_csv('price_history_testBUY.csv')
		expected_result = 1
		latest_signal = indicators.macd_signal(price_history)
		self.assertEqual(latest_signal, expected_result)
